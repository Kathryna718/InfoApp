...
function App() {
  return (
    ...
    regardless of bank affiliation- for free, and can be withdrawn in minutes.</p>
    <p> <b>Zelle</b> is an easy way to send money directly between any U.S. bank accounts typically within minutes. With just an email address or mobile phone number,</p>
    <p>you can quickly, safely and easily send and receive money with more people, regardless of where they bank.</p>
    
    <p> <b>To enroll with the ZELLE APP, enter your basic contact information, an email address and U.S mobile number and a Visa or Mastercard debit card with a U.S based account.</b>
     We do not accept debit cards associated with internationally deposits accounts or any credit card.</p>
     <p> Why use ZELLE ? Move your money in the moment with zelle, you can move money from your account to someone else within minutes.</p>
